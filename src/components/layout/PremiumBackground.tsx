...
export function PremiumBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1] bg-transparent">
      ...
      {/* Mesh Gradient Overlay - More Vivid Colors */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(14,165,233,0.4),transparent_65%),radial-gradient(circle_at_20%_80%,rgba(168,85,247,0.4),transparent_65%)] dark:bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3),transparent_65%),radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3),transparent_65%)] opacity-90 transition-opacity duration-500" />
